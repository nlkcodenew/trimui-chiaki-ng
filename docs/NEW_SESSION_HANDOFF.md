# Bàn giao session mới — trimui-chiaki-ng v0.3.1
...
Bản `v0.3.1` là bản đầu tiên có toàn bộ luồng stream native: kết nối libchiaki,
giải mã H264, hình ảnh SDL, âm thanh Opus, gamepad và rung.
...
- Tag/Release mới nhất: `v0.3.1`
- Release: `https://github.com/nlkcodenew/trimui-chiaki-ng/releases/tag/v0.3.1`
- GitHub Actions phát hành `v0.3.1` đã chạy thành công.
- `manifest.json` của Release latest trả về đúng `0.3.1`, có
...
- Chưa có kết quả kiểm thử stream `v0.3.1` trên thiết bị thật ở thời điểm bàn
  giao. Đây là bước đầu tiên của session kế tiếp.

## 5. Luồng stream v0.3.1
...
- SHA-256 binary: `209085f0cdbd64a194719ec430795593418115d8979adf92c96cb59ab5522679`.
...
2. Người dùng cập nhật/cài `v0.3.1`, bật PS4 và chọn `PS4-896`.
...
- PS4 có nhận phiên và gửi frame thật cho binary `v0.3.1` hay không.
...
là v0.3.1, release/commit 12a89c3. PS4 Pro firmware 9.00 GoldHEN đã quét và
ghép nối thật thành công; nhiệm vụ hiện tại là đọc log thiết bị đính kèm, sửa
